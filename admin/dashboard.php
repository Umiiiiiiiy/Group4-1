                    ...
                    <ion-icon name="people-sharp"></ion-icon>
                        <div class="middle">
                            <div class="left">
                                ...
                                <?php
                                    $dash_jobseekers_query = "SELECT * FROM jobseekers";
                    ...
                    <ion-icon name="people-sharp"></ion-icon>
                        <div class="middle">
                            <div class="left">
                                ...
                                <?php
                                    $dash_employers_query = "SELECT * FROM employer";
                    ...
                    <table>
                        ...
                        <tbody id="Table">
                            ...
                            <tr>
                                ...
                                <td><button style="background: rgb(86, 75, 133);color: #fff;padding: 5px 10px;border-radius: 10px;margin-top: 10px;cursor: pointer;">Verified</button></td>
