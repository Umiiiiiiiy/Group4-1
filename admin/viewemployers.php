                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody id="Table">
                            <?php
                                require_once "../connection.php";
                                $sql = mysqli_query($conn, "SELECT * FROM employer ORDER BY employeeid");
                                $count =1;
                            ...
                            <tr>
                                ...
                                <td><a href="employeeprofile.php?profid=<?php echo htmlentities($row['employeeid']);?>" style="font-size: 15px;"><button><i class="fa-solid fa-user"></i> View</button></a></td>
                            </tr>
                            <?php
                                $count = $count+1;
                                }}
