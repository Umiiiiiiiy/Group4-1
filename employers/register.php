...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO `employers`(name, age, address, phone, skills, experience, email, password, image) VALUES('$name', '$age', '$address', '$phone', '$skills', '$experience', '$email', '$pass', '$image')") or die('query failed');
